...
**** =ezcod_3_{10,11,12}= Instance Attributes
     ...
     | seper           | int   | [0,3]       | SEP_NONE, SEP_DOT, SEP_BANG, SEP_SPACE  |
     | SEP\_NONE       | int   | 0           | Output no position/parity separator     |
     | SEP\_DOT        | int   | 1 (default) | Output a '.' position/parity separator  |
     | SEP\_BANG       | int   | 2           | Output a '!' position/parity separator  |
     | SEP\_SPACE      | int   | 3           | Output a ' ' position/parity separator  |
