...
** Version 1.1.0 Available
   ...
   [[https://cdn.rawgit.com/pjkundert/ezpwd-reed-solomon/v1.1.0/js/ezpwd/ezcod.js]].
   ...
   #+BEGIN_SRC HTML
   <script
     src="//cdn.rawgit.com/pjkundert/ezpwd-reed-solomon/v1.1.0/js/ezpwd/ezcod.js">
   </script>
   #+END_SRC
...
* RSKEY: Javascript Data Key API
  ...
  consumed by error detection and correction).
   ...
   PARITY of 2-5 is supported, and any number of bytes of data.  The optional
   =sep= parameter (default 5) is the clusters to separate the RSKEY into.
...
** Javascript Library: js/ezpwd/rskey.js
   ...
   #+BEGIN_SRC HTML
   <script
     src="//cdn.rawgit.com/pjkundert/ezpwd-reed-solomon/v1.1.0/js/ezpwd/rskey.js">
   </script>
   #+END_SRC
