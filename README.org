...
** Version 1.0.1 Available
   ...
   [[https://cdn.rawgit.com/pjkundert/ezpwd-reed-solomon/v1.0.1/js/ezpwd/ezcod.js]].
   ...
   #+BEGIN_SRC HTML
   <script
     src="//cdn.rawgit.com/pjkundert/ezpwd-reed-solomon/v1.0.1/js/ezpwd/ezcod.js">
   </script>
   #+END_SRC
...
** ezpwd::RS<...>: C++ Reed-Solomon API
   ...
   // Reed Solomon coded w/ 255 symbols, up to 251 data, 4 parity symbols
   ezpwd::RS<255,251> rs;
...
** Javascript Library: js/ezpwd/rskey.js
   ...
   #+BEGIN_SRC HTML
   <script
     src="//cdn.rawgit.com/pjkundert/ezpwd-reed-solomon/v1.0.1/js/ezpwd/rskey.js">
   </script>
   #+END_SRC
...
** RSKEY Demo: HTML RSKEY Encoder/Decoder
